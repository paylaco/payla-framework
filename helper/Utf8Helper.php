...
class Utf8Helper
{
	...
	public static function strtolower($string) {
		if(self::init())
			...
			return self::unicode_to_utf8($unicode);
		}
	}
	...
	public static function slugify($str, $options = array()) {
		...
		$str = self::substr($str, 0, ($options['limit'] ? $options['limit'] : self::strlen($str)));

		// Remove delimiter from ends
		$str = trim($str, $options['delimiter']);

		return $options['lowercase'] ? self::strtolower($str) : $str;
	}
}